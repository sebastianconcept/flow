define("app/Flow-Tests", ["amber/boot", "amber_core/SUnit", "app/Flow-Binding", "app/Flow-API", "app/MiniMapless"], function($boot){
...
smalltalk.addClass('MockPerson', globals.MaplessModel, [], 'Flow-Tests');


smalltalk.addClass('MockUser', globals.MaplessModel, [], 'Flow-Tests');
...
self._model_(self._newUser());
return self}, function($ctx1) {$ctx1.fill(self,"initialize",{},globals.RivetsJSTestsController)})},
args: [],
source: "initialize\x0a\x0a\x09super initialize.\x0a\x09\x0a\x09self model: self newUser",
messageSends: ["initialize", "model:", "newUser"],
referencedClasses: []
}),
globals.RivetsJSTestsController);
...
fn: function (){
var self=this;
function $MockUser(){return globals.MockUser||(typeof MockUser=="undefined"?nil:MockUser)}
return smalltalk.withContext(function($ctx1) { 
var $2,$3,$1;
$2=_st($MockUser())._new();
...
$1=$3;
return $1;
}, function($ctx1) {$ctx1.fill(self,"newUser",{},globals.RivetsJSTestsController)})},
args: [],
source: "newUser\x0a\x0a\x09^ MockUser new \x0a\x09\x09name: 'John Galt';\x0a\x09\x09age: 42;\x0a\x09\x09yourself",
messageSends: ["name:", "new", "age:", "yourself"],
referencedClasses: ["MockUser"]
}),
globals.RivetsJSTestsController);
